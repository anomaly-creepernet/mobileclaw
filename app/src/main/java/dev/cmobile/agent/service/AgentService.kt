 ...
 * self-created crons. Both feed events into the same [dev.cmobile.agent.agent.AgentEngine].
 */
class AgentService : Service() {
    ...
    companion object {
        const val ACTION_START = "dev.cmobile.agent.START"
        const val ACTION_STOP = "dev.cmobile.agent.STOP"
